...
namespace Dhole.AI.Persistence.Auditing;

public sealed class AiAuditService(ServiceDbContext dbContext) : IAiAuditService
{
    ...
    public Task PublishAsync(AiAuditEvent auditEvent, CancellationToken cancellationToken = default)
    {
